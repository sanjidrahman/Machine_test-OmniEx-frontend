...
const routes: Routes = [
  { path: '', redirectTo: 'admin/dashboard', pathMatch: 'full' },
  {
    path: 'admin', title: 'Admin Nav', component: AdminNavigationComponent, children: [
      ...
      { path: 'receive-list', title: 'Admin Quote Ledger Activity', component: AdminReceiveActivityComponent },
      { path: 'quotes', title: 'Admin Stocks', component: AdminQuoteLedgerComponent },
      { path: 'add-quotes', title: 'Admin Add Stocks', component: AdminAddQuotesComponent },
      { path: 'receive-record', title: 'Add Quotes Record', component: AdminAddReceiveActivityComponent },
